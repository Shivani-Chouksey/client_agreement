...
const Page = () => {
    ...
    const onSubmitHandler = async (e) => {
        ...
        console.log("Data of created agreement", agrData)

        // router.push(`/agreement/client/${id}`)
                    ...
                    <form onSubmit={onSubmitHandler} className='my-5 '>
                        <div className='row  '>
                            <div className=" col-md-5 ms-5">
                                <label htmlFor="clientName" className="form-label">Add Client / Employee Name <span className='text-danger'>*</span></label>
                                ...
                                <input
                                    ...
                                    value={agrData.adminData.clientName} // Show the input value
                                    placeholder="Enter Client / Employee Name  "
                            ...
                            <div className=" col-md-5  ">
                                <label htmlFor="date" className="form-label">Add Date <span className='text-danger'>*</span></label>
                                    ...
                                    <div className="col-md-6 col-12 my-3">
                                        ...
                                        {isInputVisible ? (
                                            <input
                                                ...
                                                onChange={getClientData}
                                                onBlur={() => handleInputBlur('email')}
                                                value={agrData.clientData.email} 
                                    ...
                                    <div className="col-md-6 col-12 my-3">
                                        {isInputVisible ? (
                                            <input
                                                ...
                                                onChange={getClientData}
                                                onBlur={() => handleInputBlur('companyName')}
                                                value={agrData.clientData.companyName} 
                                                placeholder="Company Name"
                                                className="form-control"
                                            />
                                        ) : (
                        ...
                        <div className='d-flex align-item-center  justify-content-between my-4   mx-auto w-25 '> */}
                            ...
                            <div className='mt-3 d-flex gap-5' >
                                <div>
                                    ...
                                    <input type="file" className='d-none' name='signature' id="filetag" onChange={adminImgUpload} />
                                </div>
                                <div className='mt-3' style={{ height: "150px", width: "200px" }}>
                                    <img src={agrData.adminData && agrData.adminData.signature ? agrData.adminData.signature : ""} style={{ height: "100%", width: "100%", objectFit: "cover" }} id="preview" alt="Upload your  signature" />

                                    {/* <img src={agreement.adminData && agreement.adminData.signature} style={{ height: "100%", width: "100%", objectFit: "cover" }} id="preview" alt="Preview" /> */}

                                </div >
                            </div>

                            <button className="btn btn-success" type='submit' >Create Agreement </button>
                ...
                <div className='row mx-5'>
                    {
                        Array.isArray(agreement)
                            ? agreement.map((data, i) => (
                                <div key={i} className='col-md-3  bg-white p-3 ' style={{ marginRight: "5px", marginBottom: "5px" }}>
                                    <h6 >Client Name : {data.adminData.clientName}</h6>
                                    <p>Date  : {data.adminData.date}</p>
                                    <button className='btn btn-success' onClick={() => router.push(`/create-agreement/${data._id}`)}>See Agreement </button>
                                    <button className='btn btn-danger ms-4' onClick={()=>deleteHandler(data._id)}> <i class="bi bi-trash3"></i></button>
